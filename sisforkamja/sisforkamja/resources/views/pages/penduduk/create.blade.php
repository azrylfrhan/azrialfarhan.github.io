...
@section('content')
    ...
    <p class="mb-2">Perhatikan data penduduk jika sudah benar sebelum di kirim!</p>
    <div class="card shadow border-left-primary p-4 mb-4">
        ...
        <div class="row mb-4">
            ...
            <div data-mdb-input-init class="form-outline">
                <input type="text" inputmode="numeric" name="nik" id="nik" class="form-control @error('nik')
                    is-invalid @enderror" value="{{ old('nik') }}"/>
                    @error('nik')
        ...
        <div class="row mb-4">
            ...
            <div data-mdb-input-init class="form-outline">
                <input type="text" name="tempat_lahir" id="tempat_lahir" class="form-control @error('tempat_lahir')
                    is-invalid @enderror" value="{{ old('tempat_lahir') }}" />
                    @error('tempat_lahir')
                        <span class="invalid-feedback">
                        {{ $message }}
                        </span>
            ...
            <div data-mdb-input-init class="form-outline">
                <input type="date" name="tanggal_lahir" id="tanggal_lahir" class="form-control @error('tanggal_lahir')
                    is-invalid @enderror" value="{{ old('tanggal_lahir') }}" />
                    @error('tanggal_lahir')
                        <span class="invalid-feedback">
                        {{ $message }}
                        </span>
        ...
        <div class="row mb-4">
            ...
            <div data-mdb-input-init class="form-outline">
                <select name="jenis_kelamin" id="jenis_kelamin" class="form-control @error('jenis_kelamin')
                    is-invalid @enderror" value="{{ old('jenis_kelamin') }}" >
                    @error('jenis_kelamin')
                        <span class="invalid-feedback">
                        {{ $message }}
                        </span>
            ...
            <div class="col">
                ...
                <select name="agama" id="agama" class="form-control @error('agama')
                    is-invalid @enderror" value="{{ old('agama') }}" >
                    @error('agama')
                        <span class="invalid-feedback">
                        {{ $message }}
                        </span>
        ...
        <div data-mdb-input-init class="form-outline mb-4">
            <textarea name="alamat" id="alamat" cols="30" rows="5" class="form-control @error('alamat')
                    is-invalid @enderror" value="{{ old('alamat') }}" ></textarea>
        ...
        <div class="row mb-4">
            ...
            <div data-mdb-input-init class="form-outline">
                <select name="status_perkawinan" id="status_perkawinan" class="form-control @error('status_perkawinan')
                    is-invalid @enderror" value="{{ old('status_perkawinan') }}" >
            ...
            <div class="col">
                ...
                <select name="pekerjaan" id="pekerjaan" class="form-control @error('pekerjaan')
                    is-invalid @enderror" value="{{ old('pekerjaan') }}" >
                    @error('pekerjaan')
                        <span class="invalid-feedback">
                        {{ $message }}
                        </span>
        ...
        <div class="row mb-4">
            ...
            <div class="col">
                ...
                <select name="lingkungan" id="lingkungan" class="form-control @error('lingkungan')
                    is-invalid @enderror" value="{{ old('lingkungan') }}">
                    @error('lingkungan')
                        <span class="invalid-feedback">
                        {{ $message }}
                        </span>
